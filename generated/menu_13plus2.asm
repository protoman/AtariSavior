...
; note: dasm doesn't like using x or y as a label!
  ...
  MAC TEXT
	TEXT{1} eq,eq,eq,eq,eq,eq,eq,eq,eq,eq,eq,eq,eq,_,_,0
	TEXT{1} _,s,a,v,i,o,r,_,_2,_6,_0,_0,_,_,_,0
	TEXT{1} eq,eq,eq,eq,eq,eq,eq,eq,eq,eq,eq,eq,eq,_,_,0
	TEXT{1} _,_,_,_,_,_,_,_,_,_,_,_,_,_,_,0
	TEXT{1} _,_,lp,c,rp,_,_2,_0,_2,_6,_,_,_,_,_,0
	TEXT{1} _,_,u,p,p,e,r,l,a,n,d,_,_,_,_,0
	TEXT{1} _,_,_,s,t,u,d,i,o,s,_,_,_,_,_,0
	TEXT{1} _,_,_,_,_,_,_,_,_,_,_,_,_,_,_,0
	TEXT{1} _,_,_,_,_,_,_,_,_,_,_,_,_,_,_,0
	TEXT{1} _,_,_,_,_,_,_,_,_,_,_,_,_,_,_,0
	TEXT{1} _,_,_,_,_,_,_,_,_,_,_,_,_,_,_,0
	TEXT{1} _,p,r,e,s,s,_,f,i,r,e,_,_,_,_,0
	TEXT{1} _,_,t,o,_,s,t,a,r,t,_,_,_,_,_,0
  ENDM
