...
; Score digit font — 2 pixels wide, 5 rows per digit (HERO-style narrow digits)
; Each byte: bit1 = left column, bit0 = right column
; PF layout: PF0=$00 (padding), PF1=digits 0-2, PF2=digit 3
; ==============================================================================
PFDigitFont:
  .byte %10, %01, %01, %01, %10  ; 0
  .byte %01, %01, %01, %01, %01  ; 1
  .byte %10, %01, %10, %10, %10  ; 2
  .byte %10, %01, %10, %01, %10  ; 3
  .byte %01, %01, %10, %01, %01  ; 4
  .byte %10, %10, %10, %01, %10  ; 5
  .byte %10, %10, %10, %11, %10  ; 6
  .byte %10, %01, %01, %01, %01  ; 7
  .byte %10, %11, %10, %11, %10  ; 8
  .byte %10, %11, %10, %01, %10  ; 9
