...
Score_Code:		
		...
		ldx #0
        stx GRP0            ; 3 11  make sure player0 is off
        stx GRP1            ; 3 14  make sure player1 is off
        stx ENABL           ; 3 17  make sure ball is off
        stx ENAM0           ; 3 20  make sure Missile1 is off
        stx ENAM1           ; 3 23  make sure Missile0 is off     
        stx REFP0           ; 3 26  make sure reflect is off
        stx REFP1           ; 3 29  make sure reflect is off

        ldx #3                 ; 2 31  ; X now 1
        stx NUSIZ0          ; 3 34  ; player0 - 2 copies, close
        stx NUSIZ1          ; 3 37  ; player1 - 2 copies, close
		
        ldx #$FF            ; 2 40  ; +1 for HMP0
        stx RESP0           ; 3 43  ; player0 at X=63
        stx RESP1           ; 3 46  ; player1 at X=72
        stx HMP0            ; 3 49  ; fine positioning for player1
        ldx #0                ; 2 51  ; +0 for HMP1
        stx HMP1            ; 3 54  ; fine positioning for player1
        lda ScoreColor   			 ; 3 57
        sta COLUP0          ; 3 60
        sta COLUP1          ; 3 63
...
ScoreLoop       
    ...
    lda (DigitLivesTens),y        ; 4     (4)
    sta GRP0            ; 3     (7)     hello0->[GRP0]
    lda (DigitLivesOnes),y        ; 4     (11)
    sta GRP1            ; 3     (14)    hello1->[GRP1], hello0->GRP0
    lda (DigitThousands),y        ; 4     (18)
    sta GRP0            ; 3     (21)    hello2->[GRP0], hello1->GRP1
    lda (DigitHundreds),y        ; 4     (25*)   
    tax                 ; 2     (27)    hello3->X
    lda (DigitTens),y        ; 4     (31)
    sta Temp2            ; 3     (34)
    lda (DigitOnes),y        ; 4     (38)    hello5->A
    ldy Temp2            ; 3     (41)
