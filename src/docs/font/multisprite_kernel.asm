...
loop2
 lda  (scorepointers+8),y     ;+5  68  204 ; changed
 ...
 ; cycle 0
 lda  (scorepointers+$6),y  ;+5   5   15 ; changed
beginscore
 sta  GRP1            ;+3   8   24      D1     D1      D2     --
 lda  (scorepointers+$4),y  ;+5  13   39 ; changed
 sta  GRP0            ;+3  16   48      D3     D1      D2     D2
 lax  (scorepointers+$A),y  ;+5  29   87 ; changed
 txs
 lax  (scorepointers+$2),y  ;+5  36  108 ; changed
 sleep 3
 ifconst pfscore
 lda pfscore2
 sta PF1
