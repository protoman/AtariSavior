...
minikernel
	...
	sty HMP1                ; 3     (54)
    ldy #scorecount         ; 2     (56)
    lda (scorepointers+8),y   ; 5     (61) ; changed
    sta GRP0                ; 3     (64)
    ifconst pfscore
        lda pfscore1        ; 3     (67)
        sta PF1             ; 3     (70)
...
textscoreloop
         lda (scorepointers+8),y      ; 5     (66) ; changed
         sta GRP0                   ; 3     (69)
         ifconst pfscore
             lda.w pfscore1         ; 4     (73)
             sta PF1                ; 3     (76/0)
         ...
         ; cycle 0
begintextscore
         lda (scorepointers+$6),y   ; 5     (5) ; changed
         sta GRP1                   ; 3     (8)
         lda (scorepointers+$4),y   ; 5     (13) ; changed
         sta GRP0                   ; 3     (16)
         lax (scorepointers+$A),y   ; 5     (21) ; changed
         txs                        ; 2     (23*)
         lax (scorepointers+$2),y   ; 5     (28) ; changed
         ifconst scorefade
             lda stack2             ; 3     (31)
         else
             sleep 3                ; 3     (31)
...
;         lda (scorepointers+$A),y   ; 5     (42) ; changed
        lda #0
        sleep 3
         stx GRP1                   ; 3     (45)
         tsx                        ; 2     (47)
