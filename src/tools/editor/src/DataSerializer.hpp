...
public:
    ...
    static bool SaveModelsToFile(const std::vector<ModelData>& models, const std::string& filepath);
    static bool LoadModelsFromFile(std::vector<ModelData>& models, const std::string& filepath);
