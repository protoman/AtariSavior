...
.NoObject:
  lda #0                    ; 2
  sta GRP1                  ; 3  ← cycle ~16, SAFE (within HBLANK)
...
; Sprite score font: 10 digits (0-9) x 8 rows, 8-bit sprite format.
; Derived from hud_font fonthi+fontlo. Each byte is a full sprite scanline.
; Bits 7,6,5 = left 3 pixels, bit 4 = gap, bits 3,2,1 = right 3 pixels.
; Centered vertically: blank rows at top/bottom of 8-row space.
ScoreSpriteFont:
;         row0  row1  row2  row3  row4  row5  row6  row7
; 3-pixel-wide digits in bits 7-5. Bits 4-0 = 0.
; At runtime, two digits packed into one byte with 2px gap:
;   composed = digit_left | (digit_right >> 5)
;   bits: [AAA 00 BBB] where AAA=left digit, 00=gap, BBB=right digit
; 5 rows meaningful, rows 5-7 blank.
  ...
  .byte  $e0, $20, $40, $40, $40, $00, $00, $00  ; 7: ### ..# .#. _#. _#.
