...
def write_levels_index(output: Path, json_paths: list[Path]) -> None:
    ...
    The game reads LevelDataTable[Level] to start a level and place the miner:
      offset 0..6 start_room, start_x, start_y, miner_room, miner_x, miner_y,
      wall_color; offset 7..10 the level's RoomDataTable and RoomConnections
      base addresses. Entry stride is LEVEL_DATA_STRIDE (=12).
    """
